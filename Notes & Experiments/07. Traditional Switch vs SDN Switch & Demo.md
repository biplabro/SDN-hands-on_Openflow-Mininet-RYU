...
**Starting wireshark to capture the loopback interface to which the controller is pointed**
...
Flow in SDN network can be considered as the rules based on which OVS forwards the packets[8]. The below diagram shows 2-switch setup but our experiment uses Single witch which is connected to all 4 hosts and 1 SDN controller.

![Fig.3: Flow-SDN](https://github.com/biplabro/SDN-hands-on_Openflow-Mininet-RYU/blob/master/images/SDN%20Flow.png)

Fig.3: Flow-SDN

**Checking the flows of SDN**
```
...
**Understanding the Output of dump-flows**
