...
* **CRC (Cyclic redundancy check):** It is 4 bytes long field which contains a 32 bit CRC error detection sequence to ensure error free frame. [15]
...
Fig.12: 802.11 Acknowledgement HEX Dump
