...
> **Depth** stands for the numbers of layers of switches in the network. The top layer switch (s1) is connected to (n-1) no. layers of downstream switches in every linear direction. (Depth = n)
