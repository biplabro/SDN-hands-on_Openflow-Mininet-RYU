...
A more detailed installation instruction (see this Article)[https://www.saintlad.com/install-and-use-wireshark-on-ubuntu-linux/]. Users can directly run wireshark with sudo privilages without initiating WS from terminal.
